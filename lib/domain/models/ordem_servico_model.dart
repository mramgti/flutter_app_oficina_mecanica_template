...
class OrdemServico extends Entity {
  ...
  factory OrdemServico.fromMap(Map<String, dynamic> map) {
    return OrdemServico(
      ...
      dataHoraEntregaVeiculo: map['dataHoraEntregaVeiculo'] != null ? map['dataHoraEntregaVeiculo'].toString() : null,
      // dataHoraInicioServico: map['dataHoraInicioServico'] != null ? map['dataHoraInicioServico'] as String : null,
      dataHoraInicioServico: map['dataHoraInicioServico'] != null ? map['dataHoraInicioServico'].toString() : null,
      // dataHoraFimServico: map['dataHoraFimServico'] != null ? map['dataHoraFimServico'] as String : null,
      dataHoraFimServico: map['dataHoraFimServico'] != null ? map['dataHoraFimServico'].toString() : null,
